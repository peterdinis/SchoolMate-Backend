import {
  ...
  export class NoteController {
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'All notes fetched successfully.' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Student notes fetched successfully.' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'No notes found for this student' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Note fetched successfully.' })
    ...
    @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Failed to create note' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Note updated successfully.' })
    @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Failed to update note' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Note not found' })
    async updateNote(
      @Param('id') id: number,
    ...
    @ApiResponse({ status: HttpStatus.NO_CONTENT, description: 'Note deleted successfully.' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Note not found' })
    @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Failed to delete note' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Paginated notes fetched successfully.' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'No notes found for this student' })
    @ApiQuery({ name: 'page', type: Number, description: 'Page number', required: true })
    @ApiQuery({ name: 'pageSize', type: Number, description: 'Number of notes per page', required: true })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Notes found successfully.' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'No notes found matching search criteria' })
    @ApiQuery({ name: 'searchTerm', type: String, description: 'Search term (optional)', required: false })
